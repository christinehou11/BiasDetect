...
The original `SpatialExperiment` object was processed by `nnSVG()` function to identify the spatially variable genes (SVGs), and the sample spe object was obtained by filtering out the SVGs. This is specifically designed for our analysis section since the big size of the original 
