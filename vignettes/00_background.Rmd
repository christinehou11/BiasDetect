...
```{r precast k7, echo=FALSE,out.width="80%"}
knitr::include_graphics("./man/figures/precast_k7.png")
```

*Figure 1.2 PRECAST clusters: 2098 input features (SVGs), K=8*

```{r precast k8, echo=FALSE,out.width="80%"}
knitr::include_graphics("./man/figures/precast_k8.png")
```
